...
import { getChangelogEntry, execWithOutput, getChangedPackages, sortTheThings, getVersionsByDirectory } from './utils'
...
export async function runVersion({
  ...
  let prBodyPromise = (async () => {
    return (
      `This PR was opened by the [Changesets](https://github.com/gnosis/changesets-action-github-releases) GitHub action. When you're ready to do a release, you can merge this and publish to npm yourself. If you're not ready to do a release yet, that's fine, whenever you add more changesets to ${branch}, this PR will be updated.
      ${
        !!preState
          ? `
      ⚠️⚠️⚠️⚠️⚠️⚠️
